<template>
  <div class="px-[1em] pb-[3rem] sm:px-[5em] lg:px-[5em] mt-[2rem] relative mt-[5rem]">
    <h1 class="text-xl text-gray-500">
      ...
      <span class="text-base md:text-lg font-semibold"> Top Customers</span>
    </h1>
    <div class="shadow-md shadow-slate-100 drop-shadow-sm bg-white p-[1rem] rounded-xl min-h-[30rem] mt-[2rem]">
      <div class="overflow-y-scroll max-h-[8.5rem]">
        ...
        > 
          <el-table-column prop="customerName" label="CUSTOMER" width="150" show-overflow-tooltip />
          ...
          <el-table-column prop="customerNumber" label="PHONE NUMBER" width="150" show-overflow-tooltip />
